...
using MVCAppEFDataFirstApproachProductAssignment;

namespace MVCAppEFDataFirstApproachProductAssignment.Controllers
{
    public class ProductTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Product_Id,Product_Name,Rate")] ProductTable productTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Product_Id,Product_Name,Rate")] ProductTable productTable)
        {
            if (ModelState.IsValid)
            {
